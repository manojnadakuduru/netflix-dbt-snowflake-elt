...
CREATE STAGE netflixstage
  URL='s3://manoj-netflix-dbt-dataset'
  CREDENTIALS=(AWS_KEY_ID='AKIMOVIELENS.DEV.MART_MOVIE_RELEASESASU566YC3K4NQPYVN' AWS_SECRET_KEY='LsiudmPQGlmpwvwuJvylsJ9SLggUp7Vrvd43BGtV');
